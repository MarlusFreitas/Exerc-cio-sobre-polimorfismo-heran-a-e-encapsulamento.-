...
import entities.OutsourcedCharge;
...
public class Programa {
    public static void main(String[] args) throws Exception {
        ...
        int allEmpoyees = sc.nextInt();
        for(int i = 1; i <= allEmpoyees; i++){
            ...
            if( ch == 'y'){
                ...
                list.add(new OutsourcedCharge(name, hours, valuePerHour, additionalChage));
            } else{
